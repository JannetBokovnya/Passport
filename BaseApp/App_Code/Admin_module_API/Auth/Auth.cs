...
namespace App_Code.Admin_module_API
{
    ...
    public class Auth : IAuth
    {
        ...
        public int CheckModuleAccess(string pCModuleName)
        {
            ...
            try
            {
                //ExecQuery(Querys_ImpKip.GetImpAnalyzeFileLogQuery, ref oip, ref ret);
                res = dbconn.ExecuteQuery<int>("db_api.admin_api.checkModuleAccess", oip); //WRAPPER_API].[checkModuleAccess
            }
            catch (Exception e)
            {
                Log.Error(e);
