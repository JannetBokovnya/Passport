...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <%-- <script type="text/javascript">
         ...
         function applicationLoaded() {
             l_value = getIDApp("<%=DBEDITORXAP.ClientID %>");
             SetCtl(l_value); 
             return true;
         }
...
<%--<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
    <div style="height:100%; width:100%; font-size:0px;">
        <asp:Silverlight ID="DBEDITORXAP" runat="server" Source="ClientBin/Passpot.xap" InitParameters="context = 30"  Windowless="True"  Wmode="opaque"
                         MinimumVersion="2.0.31005.0" width="100%" height="100%" meta:resourcekey="DBEDITORXAPResource2" />
    </div>
</asp:Content>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
    <div style="height:100%; width:100%; font-size:0px;">
        ...
        <object id="DBEDITORXAP" data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
