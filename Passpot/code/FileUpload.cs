...
namespace DC.FileUpload
{
    ...
    public class FileUpload : INotifyPropertyChanged
    {
        ...
        public string contextPasport { get; set; }
        ...
        private DC.FileUpload.FileUploadControl.callBackMediaPanelReDraw reDrawMedia = null;

        public void Upload(DC.FileUpload.FileUploadControl.callBackMediaPanelReDraw inReDrawMedia)
        //public void Upload()
        {
            reDrawMedia = inReDrawMedia;
        ...
        void client_DownloadStringCompleted(object sender, DownloadStringCompletedEventArgs e)
        {
            ...
            UploadFileEx(Description, FileType);
        }
        ...
        public void UploadFileEx(string description, string fileType)
        {
            Status = FileUploadStatus.Uploading;
            ...
            ub.Query = string.Format("{3}filename={0}&StartByte={1}&Complete={2}&description={4}&fileTo={5}&passportKey={6}&context={7}",
                File.Name, BytesUploaded, complete, string.IsNullOrEmpty(ub.Query) ? "" : ub.Query.Remove(0, 1) + "&", description, fileType, this.passportKey, GlobalContext.Context);
